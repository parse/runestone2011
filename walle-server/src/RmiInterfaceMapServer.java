...
/*
 * This interface needs to be identical to the one at mapserver:RmiInterfaceMapServer.java
 */
public interface RmiInterfaceMapServer extends Remote {
	int receiveMessage(String x, int clientID) throws RemoteException;
